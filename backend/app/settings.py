...
CONNECTOR_SECRET_KEY = os.getenv("CONNECTOR_SECRET_KEY", "").strip()
FEDERATED_CONNECT_TIMEOUT_SECONDS = max(2, int(os.getenv("FEDERATED_CONNECT_TIMEOUT_SECONDS", "10")))
FEDERATED_QUERY_TIMEOUT_MS = max(1000, int(os.getenv("FEDERATED_QUERY_TIMEOUT_MS", "15000")))
FEDERATED_PREVIEW_ROWS = max(1, min(500, int(os.getenv("FEDERATED_PREVIEW_ROWS", "100"))))
FEDERATED_MAX_RESULT_ROWS = max(1, min(5000, int(os.getenv("FEDERATED_MAX_RESULT_ROWS", "500"))))
